...
public class Exam1 {
    public static void main(String[] args) {
        ...
        Object o6 = new BoardDto();          // toString 에 대한 오버라이딩 헀음
        ...
        System.out.println( str1 == "유재석"); // true
        System.out.println( str2 == "유재석"); // false
        // 리터럴로 정의한 문자열과 new String으로 정의한 문자열은 다르다
        System.out.println( str2.equals("유재석")); // true

        // 3. hashCode( ) : 객체를 식별하는 값을 정수로 반환 함수 , * 주소값은16()진수 *사람은 10(0~9)진수
        ...
        // 활용처 : JDBC(프로그램 시작이 아닌 DB연동 시 MYSQL 관련 클래스로드 ) , 스프링프레임워크
