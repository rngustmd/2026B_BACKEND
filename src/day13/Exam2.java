...
public class Exam2 {
    public static void main(String[] args) {
        ...
        Integer value2 = 100;   System.out.println( value2.toString() ); // 100
        ...
        // 2. 타입변환( csv , excel , api , python , json 등등 )
        ...
        System.out.println( localTime ); // 11:07:54.507546800

        // 3. 현재 날짜/시간 가져오기
        LocalDateTime localDateTime = LocalDateTime.now();
        System.out.println( localDateTime ); // 2026-08-19T11:08:46.702319700

        // 4. 정해진 날짜/시간 객체 생성 LocalDateTime.of( ) : 오버로딩(매개변수 개수에 )
        LocalDateTime localDateTime2 = LocalDateTime.of( 2026 , 8 , 19 , 11 , 11 , 11 );
        System.out.println( localDateTime2 ); // 2026년08월19일 11시11분11초

        // 5. 정해진 형식으로 날짜/시간 표현 , DateTimeFormatter.ofPattern( 패턴 );
        // 패턴 : y연도 M월 D일 h시 m분 s초 , 날짜/시간객체.formatter( 패턴객체 );
        DateTimeFormatter formatter = DateTimeFormatter.ofPattern( "y년MM월d일 hh시mm분ss초");
        System.out.println( localDateTime2.format( formatter ) ); // 2026년08월19일 11시11분11초

        // 6. 날짜 계산 , 날짜.시각객체.plusXXX
        LocalDateTime result = localDateTime2.plusDays(10); 
        System.out.println( result ); // 2026-08-29T11:11:11
        LocalDateTime result2 = localDateTime2.minusDays(20);
        System.out.println( result2 ); // 2026-07-30T11:11:11
        ...
        System.out.println( localDateTime2.getSecond() );       // 11
