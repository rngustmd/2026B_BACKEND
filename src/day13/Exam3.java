...
public class Exam3 {
    public static void main(String[] args) {
        ...
        char[ ] str2 = { '유' , '재' , '석' }; // char 타입의배열
        String str3 = "유재석"; // String 클래스는 배열의 멤버변수 가짐.!
        // 2. 문자 변환 , 
        char str4 = 65;     System.out.println(str4); // 4
        ...
        // 7. .length() : 문자열 내 문자 개수 반환
        System.out.println( str9.length() );    // 7

        // 8. .replace( ) : 만일 기존문자가 존재허면 새로운 문자로 치환하여 반환
        ...
        System.out.println( str10.substring( 0 , 6 ) ); // 0부터 6 전까지 , 012345
        ...
        // 12. .getByte( ) , 문자열내 문자들을 바이트 배열 반환
