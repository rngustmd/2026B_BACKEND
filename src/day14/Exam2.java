...
public class Exam2 {
    public static void main(String[] args) {
        ...
        // 제네릭 : 클래스내 타입들을 인흐턴스 생성시 정한다.
        /*
            컬렉션(수집) 프레임(틀) 워크(일)
                - 정의 : 데이터 수집(목록) 하는 자료주고(방법) 미리 만들어둔 인터페이스/클래스들
        ...
        */
        ...
        // 2. 향상된 for문 , :콜론 기준으로 왼쪽에 리스트(목록)들을 하나씩 왼쪽에 대입반복
        ...
        //              1000개의 자료가 있다는 가정에 일부 삭제/수정 하면 999 이동 발생
        // 즉] 삽입 빠르다.

        // LinkedList : 링크 [h헤더][d본문][t꼬리] = 노드 기반의 리스트 구조
        //              [][ A ][ B주소 ]    [A주소][B][C주소]   [B주소][C][D주소]   [C주소][D][]
        //              // E 저장한 경우 마지막 D 꼬리에 E주소 저장하고 E헤더에 D주소 저장
        //              // D 삭제한 경우 삭제할 노드에 꼬리에 주소를 헤더노드 꼬리에 대입한다.
