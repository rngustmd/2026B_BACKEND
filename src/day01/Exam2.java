...
public class Exam2 { // 클래스 시작
    ...
    public static void main(String[] args) { // 메인함수 시작
        ...
        // C/JAVA 정적(직접)타입 VS PY/JS 동적(자동으로)타입

        // 1) boolean : true 또는 false 저장하는 타입 , 1byte( 1bit -> 8bit -> 1byte )
        boolean bool1 = true; // let/const --> boolean
        System.out.println( bool1 );
        
        // 2) char : '작은따옴표로 감싼 문자 1개 저장하는 타입 , 2/3byte , 유니코드( 코드 <--> 자연어 )
        char ch1 = 'A'; //
        System.out.println( ch1 );

        // 3) String : "큰따옴표로 감싼 문자 N개 저장하는 타입" , N * 2 byte , 객체
        String str1 = "ABC";
