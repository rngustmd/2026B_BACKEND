...
public class Exam1 {
    public static void main(String[] args) {
        ...
        /*
            제네릭타입: 클래스 만들 때 타입 정하지 않고 클래스 사용할때 타입 정한다.
            List<BoardDto> list = new ArrayList<>()
                - List 인터페이스 (정의)만들 때 타입 정하지 않고 List 인터페이스 사용할 때 BoardDto 타입 정했다.
            ...
            컬렉션 프레임워크
                ...
                Map 인터페이스:     
        */
        // [1] Map : Key와 value 한쌍(엔트리)으로 여러개 쌍(엔트리) 저장하는 구조 = JSON( { } ) // DTO 구조
        ...
        map.put("강호동", 100);
        map.put("신동엽", 78);
        map.put("유재석", 80); // 주의할점: 기존에 존재하면 key 있으면 value
        ...
        //    .containsKey( 찾을value ) : 찾을value 존재하면 true / false
