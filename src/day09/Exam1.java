    ...
    public static void main(String[] args) {
        ...
        ArrayList 클래스 : 
            ...
            3. 사용법
                ...
                - 제네릭타입: 리스트 내 저장할 요소들의 타입, 즉] <String> 리스트에 여러개 String 저장
            ...
            4. 주요메소드
                ...
                3) .set( 인덱스 , 자료 ) : 리스트 특정인덱스 요소 수정
                    리스트명.get(1) = "강호동"
                    배열명[1] = "강호동"
                4) .size() : 리스트 내 요소 개수 반환
                5) .get( 인덱스 ) : 리스트 특정 인덱스 요소 값 반환
                6) .remove( 인덱스 ) : 리스트 특정인덱스 삭제
                7) .clear() : 리스트 요소 전체 삭제
                8) .indexOf( 찾을값 ) : 리스트 내 찾을 값이 존재하면 인덱스 없으면 -1 반환
                9) .contains( 찾을값 ) : 리스트 내 찾을 값이 존재하면 true 없으면 false 반환
        ...
        */
        ...
        // [5] 리스트 요소 수정
        변수명1.set(1, "서장훈");
        System.out.println( 변수명1 ); // [유재석 , 서장훈 , 상호동, 신동엽]
        // [6] 리스트 요소 총계수
        ...
        System.out.println( 변수명1.contains("강호동"));    // '강호동' 찾을 값이 있으면 true 없으면 false
        // [10] 반복문과 리스트 관계
        // 1. 일반 for문
        for( int index = 0 ; index <= 변수명1.size() -1 ; index ++ ){ }
        // 2. 향상된 for문 , : 콜론기준 오른쪽 리스트 내 요소 *하나씩* 왼쪽 변수에 (반복) 대입
        for( String str : 변수명1 ){ }
        // [11] 리스트 전체 삭제
        변수명1.clear();
        // [12] 리스트 요소 여부 확인
