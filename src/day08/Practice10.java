...
// [1]
class Member{ private String id; public String getId() { return id;} public void setId(String id) { this.id = id; } }
// [2]
class Score{ private int score; public void setScore(int score) { if( score >= 0 && score <= 100){ this.score = score; System.out.println( score );
}else{ System.out.println(" 유효하지 않은 점수입니다. "); } } }
// [3] 
class BankAccount{ private String accountNumber; BankAccount( String accountNumber ){ this.accountNumber = accountNumber;}
                   public String getAccountNumber() { return accountNumber; } }
// [4]
class CircleCalculator{ public final double PI = 3.14159; public void printCircleArea( int 반지름 ){ System.out.println( 반지름 * 반지름 * PI ); } }
// [5]
class TicketMachine{
