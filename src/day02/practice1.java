...
public class practice1 { // class start
    ...
    public static void main(String[] args) { // main start
        ...
        // 4. + 더하기연산자 와 연결연산자
        System.out.println( "제 이름은 "+name+" , 나이는 "+age2+" , 키는 "+height+"cm 입니다. ");
        ...
        // 9. 8번에 Scanner 만들었기 때문에 이어서 사용 , nextLine() 띄어쓰기 포함 입력 , 
        // nextLine() 주의할점 : 만약에 nextLine() 앞에 다른 nextXX() 존재한 경우에는 사이에 의미없는 nextLine() 추가
        System.out.print( " 게시물 번호: " ); int 번호 = scan.nextInt();
        scan.nextLine(); // nextInt() 3 입력 후 엔터 (\n) 치면 3 반환되고 엔터(\n) 유지(남는다) 된다. \n 초기화
        System.out.print( " 게시물 제목: " ); String 제목 = scan.nextLine();
        System.out.print( " 게시물 내용: " ); String 내용 = scan.nextLine();

        // 10. nextChar() 제공하지 않는다. next().charAt(인덱스) : 해당 인덱스의 문자 1개 추출함수 , *문자열은 배열이다.*
        System.out.print( "성별을 입력하세요(남/여): "); char 성별 = scan.next().charAt(0);
        System.out.printf("입력하신 성별은 %s 입니다. \n" , 성별 );

        // 11.
        System.out.println( " ----------- 자기소개 ---------- " );
        System.out.print( "이름을 입력하세요: "); String 이름2 = scan.next();
        System.out.print( "나이를 입력하세요: "); int 나이2 = scan.nextInt();
        System.out.print( "키를 입력하세요: " ); double 키 = scan.nextDouble();
        System.out.print( "프로그래머 입니까? (true/false): "); boolean 프로그래머 = scan.nextBoolean();
        System.out.println( "이름: " + 이름2 );
        System.out.println( "나이: " + 나이2 );
        System.out.println( "키: " + 키 + "cm ");
        System.out.println( "프로그래머 여부: " + 프로그래머);
