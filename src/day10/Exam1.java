...
public class Exam1 {
    public static void main(String[] args) {
        ...
        chicken1.name = "닭";       
        chicken1.show();            
        // 즉] 자식이 태아나면 부모도 같이 태어난다! = 상위클래스가 먼저 생성되고 하위 클래스 객체가 생성된다.

        // [******] 다형성 [******]
        // *하나의 자료*가 다양한 형(형식/모양/형태/구분) 성질
        // 1. 참새 타입 에서 조류 타입 으로 될까?
        // 가능한 이유 : 1) 상속관계(논리) 2) 참새인스턴스가 생성될떄 + 동물인스턴스도생성(물리)
        ...
        참새 sparrow3 = (참새)animal1; // 오류발생? 동물1 태어날 때 참새가 생성되지 않았다.
