...
public class Exam3 {
    public static void main(String[] args) {
        ...
        /*
            ...
            특징 : 1) 동일한타입끼리    2) 고정(고정)길이   3) 요소초기값(자동초기값) 정수: 0 , 실수: 0.0 , 논리: false , 객체: null
        ...
        */
        ...
        System.out.println( arry1 );        // I@4517d9a3 배열(객체)의 메모리 주소값
        ...
        System.out.println( arry2.length ); // 배열변수명.length : 요소 총계수
        System.out.println( arry2[1] );     // 1번 인덱스의 자료 호출 , '강호동'
        // [*] 선언 이후 에 길이(요소) 추가push/삭제splice 안된다.
        arry2[0] = "유재석2"; System.out.println( arry2[0] ); // 기존 요소에 새로운 값으로 수정
        // arry2[3] = "하하"; arry2.push = "하하"; // 오류 , 즉 요소 추가 없다.
        ...
        /* 배열 메모리 : 메모리는 1byte 단위로 저장!
            ...
            즉] 배열은 요소 내 모든 인덱스 주소값 참조하지 않고 *가장 앞*에 있는 주소값 1개만 참조한다.
            배열명[0] = 101 
            배열명[1] = 타입크기(byte)만큼이동 1번 이동 = 201 
            배열명[2] = 타입크기만큼이동 2번 이동 = 301 
        */
