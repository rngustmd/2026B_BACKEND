...
public class Exam2 {
    public static void main(String[] args) {
        ...
        // 5. 반복문 과 배열 관계 : 배열 내 저장된 자료들을 인덱스(저장된순서번호) 로 식별
        int[ ] ary = { 92 , 80 , 75 }; // 자바 배열! [vs] 자바스크립트 배열
        // * 배열은 인덱스가 0부터 마지막 인덱스까지 순차 저장
        for( int 인덱스 = 0 ; 인덱스 < ary.length ; 인덱스++ ){ System.out.println( ary[인덱스] ); }
        // * 향상된 for문 ( ) , for( 타입명 변수명 : 배열명 ){ } ,  : 콜론 기준 오른쪽 배열 내 요소들을 왼쪽 변수에 하나씩 대입
        for( int data : ary ){ 
